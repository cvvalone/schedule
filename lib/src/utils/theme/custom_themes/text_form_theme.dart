...
class ScheduleTextFormFieldTheme {
  ...
  static final lightTextFormFieldTheme = InputDecorationTheme(
    ...
    labelStyle: const TextStyle().copyWith(fontSize: 14, color: ScheduleColors.wBTextColor),
    ...
    floatingLabelStyle: const TextStyle().copyWith(color: ScheduleColors.wBTextColor),
  );
